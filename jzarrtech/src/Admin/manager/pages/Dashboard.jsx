...
import { FaChartLine, FaUserSlash, FaClock, FaCheckCircle } from "react-icons/fa";
...
const Dashboard = () => {
  ...
  const handleExportCsv = () => {
    ...
    link.href = url;
    link.download = "jzarrtech-manager-leads.csv";
    link.click();
  ...
  const handleExportPdf = () => {
    ...
    printWindow.document.write(`
      <html>
        <head>
          <title>JzarrTech Manager Leads</title>
          <style>
    ...
    >
      <div className="stats-grid">
        ...
        <StatCard
          title="Unassigned"
          value={
            leads.filter((lead) => lead.assigned === "No Assignment").length
          }
          color="#F59E0B"
          icon={<FaUserSlash />}
        />
